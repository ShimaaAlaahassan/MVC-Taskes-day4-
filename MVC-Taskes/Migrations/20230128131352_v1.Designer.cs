...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVC_Taskes.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("MVC_Taskes.Models.DepartmentLocation", b =>
                {
            ...
            modelBuilder.Entity("MVC_Taskes.Models.Dependent", b =>
                {
            ...
            modelBuilder.Entity("MVC_Taskes.Models.Employee", b =>
                {
                    b.Property<int>("SSN")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_Taskes.Models.Project", b =>
                {
                    b.Property<int>("Number")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_Taskes.Models.WorksOnProject", b =>
                {
                    b.Property<int>("EmpSSN")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_Taskes.Models.Department", b =>
                {
                    b.HasOne("MVC_Taskes.Models.Employee", "employeeManege")
                        .WithOne("DepartmentManege")
                        .HasForeignKey("MVC_Taskes.Models.Department", "mngrSSN");
            ...
            modelBuilder.Entity("MVC_Taskes.Models.DepartmentLocation", b =>
                {
                    b.HasOne("MVC_Taskes.Models.Department", "Department")
            ...
            modelBuilder.Entity("MVC_Taskes.Models.Dependent", b =>
                {
                    b.HasOne("MVC_Taskes.Models.Employee", "Employee")
                        .WithMany("Dependents")
            ...
            modelBuilder.Entity("MVC_Taskes.Models.Employee", b =>
                {
                    b.HasOne("MVC_Taskes.Models.Employee", "Supervisor")
                        .WithMany("Employees")
                        .HasForeignKey("SupervisorSSN");

                    b.HasOne("MVC_Taskes.Models.Department", "DepartmentWork")
            ...
            modelBuilder.Entity("MVC_Taskes.Models.WorksOnProject", b =>
                {
                    b.HasOne("MVC_Taskes.Models.Employee", "Employees")
                        .WithMany("WorksOnProjects")
                        .HasForeignKey("EmpSSN")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVC_Taskes.Models.Project", "Project")
                        .WithMany("WorksOnProjects")
